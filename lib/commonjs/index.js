...
var _exportNames = {
  ...
  request3DSecurePaymentCheck: true
};
exports.getDeviceDataFromDataCollector = getDeviceDataFromDataCollector;
exports.request3DSecurePaymentCheck = request3DSecurePaymentCheck;
...
async function request3DSecurePaymentCheck(options) {
  try {
    const result = await ExpoBraintree.request3DSecurePaymentCheck(options);
    return result;
  } catch (ex) {
    return ex;
  }
